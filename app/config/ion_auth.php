 ...
 */
$config['site_title']                 = "SistemaTPV";       // Site Title, example.com This is not more functional
$config['admin_email']                = "asysfull@gmail..com"; // Admin Email, admin@example.com This is not more functional
