...
$config['aws_url'] = 'http://www.ccasanisoft.com:8080/FEApi/api/';
$config['ws_almacen'] = 'http://localhost:81/PJAPI-ALMACEN/';
$config['ws_general'] = 'http://localhost:81/PJAPI-GENERAL/';


/*$config['wsnc_url'] = 'http://localhost/ws_ventas_TPV/';
$config['ws_almacen'] = 'http://localhost:8080/web_ventas_TPV/';
$config['ws_general'] = 'http://localhost:8080/ws_general_tpv/';*/
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
