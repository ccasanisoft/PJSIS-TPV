            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="well well-sm">
                        ...
                        <p><?= "<span class=\"text-info\">".lang("csv1")."</span><br /><span class=\"text-success\">". lang("csv2")." (<b>".lang("category_code").", ".lang("category_name")." y ".lang("parent_category_name")."</b>)</span> <span class=\"text-primary\">".lang("csv4")."</span>"; ?></p>
                    </div>
