...
var n = new Date();
var fs=n.getMonth()+1 +"-"+n.getFullYear();
    $(document).ready(function () {
        dibujar(["Total"],[<?php echo $yearData  ?>]);
...
function dibujar(meses,datameses){
...
<!-- graficos -->
            <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title"><?= lang('sales_chart'); echo " ". date("Y") ?></h3>
                        </div>
                        <div class="box-body">
            ...
            <div class="row">
              <div class="col-md-8">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Ventas <?php echo date("M"); ?></h3>
                        </div>
                        <div class="box-body">
                            <div style=""><canvas id="myChart" style="height: 300px"></canvas></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header">
                            <?php $me=["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"];
                             $now = date("m"); ?>
                    <h3 class="box-title">
                        Producto con Mayor Salida(<?php echo $me[$now-1] ?>)
                    </h3>
                        </div>
                        <div class="box-body">
