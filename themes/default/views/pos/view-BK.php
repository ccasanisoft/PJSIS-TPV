                ...
                <p><h3>
                    <?php 
                        if($inv->document_type==1){
                            echo strtoupper(lang("bill_title"));
                        }else{
                            echo strtoupper(lang("invoice_title"));
                        }
                    ?>
                    </h3>
                </p>
            ...
            <table class="table table-striped table-condensed">
                ...
                foreach ($rows as $row) {
                    ...
                    if ($inv->total_discount != 0) {
                        $price_with_discount = $this->tec->formatMoney($row->affect_price + $this->tec->formatDecimal($row->item_discount / $row->quantity));
                    ...
                    echo $this->tec->formatMoney($row->affect_price + ($row->item_tax / $row->quantity)) . '</td><td class="text-right">' . $this->tec->formatMoney($row->subtotal) . '</td></tr>';
                }
                ?>
                </tbody>
                <tfoot>
