    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <table width="100%" class="stable">
                <tr>
                    ...
                    <td style="text-align:right; border-bottom: 1px solid #EEE;"><h4>
                            <span><?= "S/ " . $this->tec->formatMoney($this->session->userdata('cash_in_hand')); ?></span></h4>
                    </td>
                </tr>
                <tr>
                    <td style="border-bottom: 1px solid #EEE;"><h4><?= lang('cash_sale'); ?>:</h4></td>
                    <td style="text-align:right; border-bottom: 1px solid #EEE;"><h4>
                            <span><?= "S/ " . $this->tec->formatMoney($cashsales->paid ? $cashsales->paid : '0.00') . ' (' . $this->tec->formatMoney($cashsales->total ? $cashsales->total : '0.00') . ')'; ?></span>
                        </h4></td>
                </tr>
                <tr>
                    <td style="border-bottom: 1px solid #EEE;"><h4><?= lang('ch_sale'); ?>:</h4></td>
                    <td style="text-align:right;border-bottom: 1px solid #EEE;"><h4>
                            <span><?= "S/ " . $this->tec->formatMoney($chsales->paid ? $chsales->paid : '0.00') . ' (' . $this->tec->formatMoney($chsales->total ? $chsales->total : '0.00') . ')'; ?></span>
                        </h4></td>
                </tr>
                <tr>
                    ...
                    <td style="text-align:right;border-bottom: 1px solid <?= (!isset($Settings->stripe)) ? '#DDD' : '#EEE'; ?>;"><h4>
                            <span><?= "S/ " . $this->tec->formatMoney($ccsales->paid ? $ccsales->paid : '0.00') . ' (' . $this->tec->formatMoney($ccsales->total ? $ccsales->total : '0.00') . ')'; ?></span>
                        </h4></td>
                </tr>
                ...
                <?php if (isset($Settings->stripe)) { ?>
                    <tr>
                        ...
                        <td style="text-align:right;border-bottom: 1px solid #DDD;"><h4>
                                <span><?= "S/ " . $this->tec->formatMoney($stripesales->paid ? $stripesales->paid : '0.00') . ' (' . $this->tec->formatMoney($stripesales->total ? $stripesales->total : '0.00') . ')'; ?></span>
                            </h4></td>
                    </tr>
                <?php } ?>
                <tr>
                    ...
                    <td width="200px;" style="font-weight:bold;text-align:right;"><h4>
                            <span><?= "S/ " . $this->tec->formatMoney($totalsales->paid ? $totalsales->paid : '0.00') . ' (' . $this->tec->formatMoney($totalsales->total ? $totalsales->total : '0.00') . ')'; ?></span>
                        </h4></td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="200px;" style="font-weight:bold;text-align:right;"><h4>
                            <span><?= "S/ " . $this->tec->formatMoney($expenses->total ? $expenses->total : '0.00'); ?></span>
                        </h4></td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right;"><h4>
                            <span><strong><?= "S/ " . $this->tec->formatMoney($total_cash); ?></strong></span>
                        </h4></td>
                </tr>
            </table>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <?= form_hidden('total_cheques', $chsales->total); ?><!--*************************TRJ026 - ALEXANDER ROCA - 01/04/2019********************-->
                            <?= form_input('total_cheques_submitted', (isset($_POST['total_cheques_submitted']) ? $_POST['total_cheques_submitted'] : $chsales->total), 'class="form-control input-tip" id="total_cheques_submitted" required="required"'); ?><!--*************************TRJ026 - ALEXANDER ROCA - 01/04/2019********************-->
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <?= form_hidden('total_cc_slips', $ccsales->total); ?><!--*************************TRJ026 - ALEXANDER ROCA - 01/04/2019********************-->
                            <?= form_input('total_cc_slips_submitted', (isset($_POST['total_cc_slips_submitted']) ? $_POST['total_cc_slips_submitted'] : $ccsales->total), 'class="form-control input-tip" id="total_cc_slips_submitted" required="required"'); ?><!--*************************TRJ0 - ALEXANDER ROCA - 01/04/2019********************-->
                        </div>
						<!--*************************TRJ026 - ALEXANDER ROCA - 01/04/2019********************-->
						<div class="form-group">
                            <?= lang("total_c_stripe", "total_stripe_submitted"); ?>
                            <?= form_hidden('total_stripe', $stripesales->total); ?>
                            <?= form_input('total_stripe_submitted', (isset($_POST['total_stripe_submitted']) ? $_POST['total_stripe_submitted'] : $stripesales->total), 'class="form-control input-tip" id="total_stripe_submitted" required="required"'); ?>
                        </div>
            ...
            <div class="modal-footer">
                ...
                <?= form_submit('close_register', lang('close_register'), 'class="btn btn-primary" id="close_register"'); ?>
            </div>
        </div>
        <?= form_close(); ?>
    </div>
