                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    $cadd.= '<option value="" selected="selected">'.lang("select")." ".lang("category").'</option>\n';
                                                    ...
                                                    foreach($hijos1->hijos as $hijos2) {
                                                        ...
                                                        if(isset($hijos2->hijos)){
                                                            foreach($hijos2->hijos as $hijos3) {
                                                                $cadd.= "<option value='".$hijos3->id."'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$hijos3->name."</option>\n";
                                                            }
                                                        }
                                                    }
                                                }
                                ...
                                <div class="form-group all">
                                    <div class="form-group">
                                        ...
                                        ?>
                                        <?= form_dropdown('maker', $sp, set_value("0"), 'class="form-control select2 maker" id="maker" style="width:100%;"'); ?>
                                    </div>
                                </div>
                                ...
                                <?php switch($this->session->userdata('negocio')){
                                    ...
                                    case 1: ?>
                                        <div class="form-group" id="st">
                                            ...
                                            <?= form_input('custom_field_1', set_value('custom_field_1', ""), 'class="form-control tip" id="custom_field_1"'); ?>
                                        </div>
                                        <div class="form-group" id="st">
                                            <?= lang('pharmacological_action', 'pharmacological_action'); ?>
                                            <?= form_input('custom_field_2', set_value('custom_field_2', ""), 'class="form-control tip" id="custom_field_2"'); ?>
                                        </div>
                                        <?php break;
                                } ?>
                                ...
                                <div class="form-group" id="st">
                                    ...
                                    <select name="almacen" id="almacen" class="form-control select2 tip">
                                        <?php foreach ($almacenes as $a): ?>
                                             <option value="<?php echo $a->id ?> "><?php echo $a->warehouse ?></option>
                                        <?php endforeach ?>
                                ...
                                <div class="form-group" id="st">
                                    ...
                                    <?= form_input('presentation', set_value('presentation', ""), 'class="form-control tip" id="presentation"'); ?>
                                </div>
                                <div class="form-group" id="st">
                                    <?= lang('stock', 'stock'); ?>
                                    <?= form_input('stock', set_value('stock', ""), 'class="form-control tip" id="stock"'); ?>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?= form_dropdown('currency', $cy, set_value('currency', $this->Settings->currency_prefix), 'class="form-control tip select2" id="currency"  required="required" style="width:100%;"'); ?>
                                </div>
                            </div>
                            ...
                            <!-- <div class="form-group">
                                ...
                                <?= form_input('product_tax', set_value('product_tax', $this->Settings->default_tax_rate), 'class="form-control tip" id="product_tax"  required="required"'); ?>
                            </div> -->

                            <div class="col-md-3">
                                <div class="form-group">
                                    <?= lang('tax_method', 'tax_method'); ?>
                                    <?php $tm = array(0 => lang('inclusive'), 1 => lang('exclusive'), 2 => lang('exonerated'), 3 => lang('exo') ); ?>
