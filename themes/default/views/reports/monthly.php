                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="info-box bg-aqua">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number"><?= "S/ " . $this->tec->formatMoney($total_sales->total_amount) ?></span>
                                        <div class="progress">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="info-box bg-yellow">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number"><?= "S/ " . $this->tec->formatMoney($total_purchases->total_amount) ?></span>
                                        <div class="progress">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="info-box bg-red">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number"><?= "S/ " . $this->tec->formatMoney($total_expenses->total_amount) ?></span>
                                        <div class="progress">
                                            <div style="width: 0%" class="progress-bar"></div>
                                        </div>
                                        <span class="progress-description">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="info-box bg-green">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number"><?= "S/ " . $this->tec->formatMoney($total_sales->total_amount-$total_purchases->total_amount-$total_expenses->total_amount) ?></span>
                                        <div class="progress">
                                            <div style="width: 100%" class="progress-bar"></div>
                                        </div>
                                        <span class="progress-description">
