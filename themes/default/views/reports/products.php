...
<script>
    $(document).ready(function() {
        ...
        $('#fileData').dataTable( {
            ...
            "aoColumns": [null, null, {"bSearchable": false}, {"mRender":currencyFormat, "bSearchable": false}, {"mRender":currencyFormat, "bSearchable": false}, {"mRender":currencyFormat, "bSearchable": false}]
        });
                                ...
                                <table id="fileData" class="table table-striped table-bordered table-hover" style="margin-bottom:5px;">
                                    <thead>
                                        <tr class="active">
                                            ...
                                            <th class="col-xs-1"><?= lang("cant_sold"); ?></th>
                                            <!-- <th class="col-xs-1"><?= lang("tax"); ?></th> -->
                                            <th class="col-xs-1"><?= lang("total_cost") . " (S/)"; ?></th>
                                            <th class="col-xs-1"><?= lang("total_sale") . " (S/)"; ?></th>
                                            <th class="col-xs-1"><?= lang("profit") . " (S/)"; ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
