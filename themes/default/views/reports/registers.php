...
<script>
    $(document).ready(function () {
        ...
        $('#registerTable').dataTable({
            ...
            "aoColumns": [{"mRender":hrld}, {"mRender":closed_at}, null,  {"mRender":currencyFormat}, {"mRender":total_cash}, {"mRender":total_cash}, {"mRender":total_cash}, {"mRender":total_cash}, {"mRender":total_cash}, null]//***********TRJ026 - ALEXANDER ROCA - 02/04/2019***********
        });
    });
</script>
                        ...
                        <div class="table-responsive">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-xs-1"><?= lang('cash_in_hand') . " (S/)"; ?></th>
                                    <th class="col-xs-1"><?= lang('total_cc_slips') . " (S/)"; ?></th>
									<th class="col-xs-1"><?= lang('total_c_stripe') . " (S/)"; ?></th><!--***********TRJ026 - ALEXANDER ROCA - 01/04/2019***********-->
                                    <th class="col-xs-1"><?= lang('Cheques') . " (S/)"; ?></th>
                                    <th class="col-xs-1"><?= lang('total_cash') . " (S/)"; ?></th>
									<th class="col-xs-1"><?= lang('total_sales') . " (S/)"; ?></th><!--***********TRJ026 - ALEXANDER ROCA - 02/04/2019***********-->
